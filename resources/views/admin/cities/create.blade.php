...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
    <div class="px-6 py-4 border-b border-gray-100 bg-gray-50/50">
        <h1 class="text-xl font-bold text-gray-900">Yeni İl Ekle</h1>
        <p class="text-sm text-gray-500 mt-1">Sipariş verilebilecek yeni bir il ekleyin.</p>
    </div>
    <form action="{{ route('admin.cities.store') }}" method="POST" class="p-6">
        @csrf
        <div class="grid gap-6 sm:grid-cols-2">
            ...
            <div>
                ...
                <input type="number" name="min_order_amount" value="{{ old('min_order_amount', 0) }}" min="0" step="0.01" class="w-full border border-gray-200 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-amber-500 focus:border-amber-500" placeholder="0">
