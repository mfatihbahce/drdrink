...
<div class="mb-6 flex justify-between items-center">
    ...
    <a href="{{ route('admin.categories.create') }}" class="bg-amber-600 hover:bg-amber-500 text-white px-4 py-2 rounded font-medium">Yeni Kategori</a>
</div>
        ...
        <tbody class="divide-y divide-gray-200">
            @foreach($categories as $category)
                <tr>
                    ...
                    <td class="px-6 py-4">{{ $category->store?->name ?? '-' }}</td>
                    <td class="px-6 py-4">
                    ...
                    <td class="px-6 py-4 text-right">
                        <a href="{{ route('admin.categories.edit', $category) }}" class="text-amber-600 hover:text-amber-700 mr-2">Düzenle</a>
